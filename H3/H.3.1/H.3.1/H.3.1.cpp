...
//extern HMENU allmenu[2];
HMENU allmenu::menu[2] = { 0, 0 };
int allmenu::currentMenu = 0;
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CREATE:
	{	allmenu mymenu;
		mymenu(0) = GetMenu(hWnd);
		mymenu(1) = LoadMenu(hInst, MAKEINTRESOURCE(IDR_MENU2));
		break;
	}
		break;
	case WM_COMMAND:
		...
		return allmenu::menuProc(hWnd, message, wParam, lParam, wmId, wmEvent, ps, hInst, hdc);
